<x-layout title="API Terms | FX Tracker" header="header-regular" hero-tag="policy" hero-title="API Terms"
    ...
    <div class="max-w-4xl">
        ...
        <article class="space-y-8">
            <section>
                ...
                <p class="text-slate-700">FX Tracker provides authenticated access to a historical exchange rate API.
                    The API currently supports currency-pair queries over date ranges and is governed by these API Terms
                    and all applicable platform policies.</p>
            </section>

            <section>
                <h2 class="text-2xl font-semibold text-slate-900">2. Authentication</h2>
                <p class="text-slate-700">API access requires authentication via an API key. API keys are personal and
                    confidential. You are responsible for:</p>
            ...
            <section>
                ...
                <p class="text-slate-700">API usage is subject to monthly plan quotas and platform protection limits:
                </p>
                <ul class="list-inside list-disc space-y-2 text-slate-700">
                    ...
                    <li>Exceeding your monthly allowance will result in HTTP 429 responses until the next monthly reset
                        or plan upgrade</li>
            ...
            <section>
                ...
                <p class="text-slate-700">The historical exchange rate dataset provided through the API has the
                    following limitations:</p>
                <ul class="list-inside list-disc space-y-2 text-slate-700">
                    <li>Data is provided for <strong>business days only</strong> (Monday–Friday), excluding weekends and
                        public holidays</li>
                    <li>Not every calendar day is represented in the dataset</li>
                    <li>Historical gaps may exist for certain date ranges or currency pairs depending on data source
                        availability</li>
                    <li>The number of data points returned reflects available snapshots; gaps do not indicate API errors
                    </li>
            ...
            <section>
                ...
                <p class="text-slate-700">We aim to maintain 99% uptime, but cannot guarantee 100% availability.
                    Scheduled maintenance and emergencies may cause temporary service interruptions.</p>
            </section>
            ...
            <section>
                ...
                <ul class="list-inside list-disc space-y-2 text-slate-700">
                    ...
                    <li>May be cached by you for reasonable internal use, provided you do not misrepresent the data as
                        your own source</li>
            ...
            <section>
                ...
                <p class="text-slate-700">FX Tracker may deprecate or modify API endpoints with 30 days' notice.
                    Breaking changes require migration guidance and support.</p>
            </section>
            ...
            <section>
                ...
                <p class="text-slate-700">Complete API documentation is available on our API documentation page. Paid
                    plans can be purchased through online checkout and managed through the billing portal where
                    available. Support inquiries can be directed to support@infinitefinances.co.uk</p>
            </section>

            <section>
                <h2 class="text-2xl font-semibold text-slate-900">10. Liability Disclaimer</h2>
                <p class="text-slate-700">FX Tracker is not liable for any damages arising from API usage, including
                    data loss, business interruption, or financial losses resulting from inaccurate historical data or
                    derived calculations.</p>
            </section>
        </article>
    </div>
</x-layout>
