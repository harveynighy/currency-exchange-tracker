<x-layout>
    <div class="max-w-4xl">
        ...
        <div class="mb-12 rounded-3xl border border-blue-100 bg-linear-to-r from-blue-50 to-white px-8 py-12">
            <h1 class="text-4xl font-bold text-slate-900">Data Processing Agreement</h1>
        ...
        <article class="space-y-8">
            ...
            <section>
                <h2 class="text-2xl font-semibold text-slate-900">3. Legal Basis for Processing</h2>
                <p class="text-slate-700">We process personal data based on:</p>
            ...
            <section>
                <h2 class="text-2xl font-semibold text-slate-900">4. Data Subjects' Rights</h2>
                <p class="text-slate-700">You have the right to:</p>
                <ul class="list-inside list-disc space-y-2 text-slate-700">
            ...
            <section>
                <h2 class="text-2xl font-semibold text-slate-900">5. International Transfers</h2>
                <p class="text-slate-700">Where applicable, we ensure data transfers comply with GDPR adequacy decisions and implement standard contractual clauses.</p>
            </section>
