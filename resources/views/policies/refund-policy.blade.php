<x-layout>
    <div class="max-w-4xl">
        ...
        <div class="mb-12 rounded-3xl border border-blue-100 bg-linear-to-r from-blue-50 to-white px-8 py-12">
            <h1 class="text-4xl font-bold text-slate-900">Refund Policy</h1>
        ...
        <article class="space-y-8">
            ...
            <section>
                <h2 class="text-2xl font-semibold text-slate-900">4. Non-Refundable Items</h2>
            ...
            <section>
                <h2 class="text-2xl font-semibold text-slate-900">7. Exceptions</h2>
                <p class="text-slate-700">FX Tracker reserves the right to deny refunds if we determine the request violates our Terms of Service or Acceptable Use Policy.</p>
            </section>
        </article>
    </div>
</x-layout>
